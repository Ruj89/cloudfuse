...
import net.ruj.cloudfuse.clouds.controllers.OAuth2CloudStorageConnectorGenericController;
...
public class GDriveConnectorController extends OAuth2CloudStorageConnectorGenericController<GDriveService> {
